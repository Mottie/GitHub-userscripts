...
// @updateURL   https://raw.githubusercontent.com/Mottie/Github-userscripts/master/meta/github-watcher.meta.js
...
(() => {
	...
	const buttonPanel = index => `
		...
		<button type="button" data-type="delete" data-index="${index}" class="ml-1 text-red" aria-label="Delete">
			...
			<ul>
				...
				<li class="ghwr-last-checked text-gray-light d-flex flex-items-center flex-justify-between">
					<span class="d-flex flex-items-center flex-start">
						...
						${error && `<span class="ghwr-api-error ml-2 text-red" role="alert">${error}</span>`}
					</span>
